...
# --- [데이터 전처리: 1번 & 2번 차트 공통] ---
# 모든 자치구의 기준 대학 수를 먼저 가져옵니다.
df_univ_base = run_query('SELECT "행정구" AS 자치구, COUNT(DISTINCT "학교명") AS 대학교수 FROM "서울시대학" GROUP BY "행정구"')
